...
class SettingsDatabase extends Model
{
    ...
    */
    ...
    public static function updateIPCAfromIBGE()
    {
        ...
        $periods = SettingsDatabase::generatePeriods();
        ...
        try {
            ...
            /*$response = Http::timeout(60) // Timeout set to 60 seconds
                ->get($API_query);*/
            $data = $response->json();
     ...
     */
    public static function updateSalesFromSysmo($meantime = null, $database = null)
    {
        /*
