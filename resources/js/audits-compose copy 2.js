...
window.addEventListener('load', function() {
        ...
        if (blocksContainer) {
            ...
            newBlock.innerHTML = `
                <div class="input-group">
                    ...
                    <button type="button" class="btn btn-outline-light waves-effect cursor-n-resize" title="Reordenar" tabindex="0"><i class="ri-arrow-up-down-line text-body"></i></button>

                    <button type="button" class="btn btn-outline-light waves-effect btn-accordion-toggle" tabindex="0"><i class="ri-arrow-up-s-line"></i></button>
                </div>
                <div class="accordion-collapse collapse show">
                    <div class="nested-receiver-block border-1 border-dashed border-dark mt-0 p-1 rounded-0"></div>

                    <div class="clearfix">
                        <button type="button" class="btn btn-outline-light waves-effect btn-remove-block float-start" data-target="${newBlockIndex}" title="Remover Bloco" tabindex="0"><i class="ri-delete-bin-line text-danger text-opacity-50"></i></button>

                        <button type="button" class="btn btn-outline-light waves-effect btn-add-topic float-end cursor-copy text-theme" data-block-index="${newBlockIndex}" title="Adicionar Tópico" tabindex="0"><i class="ri-menu-add-line"></i></button>
                    </div>
                </div>
            `;
    ...
    function addNewTopic(stepIndex) {
        ...
        if (blockContainer) {
            ...
            newTopic.innerHTML = `
                <button type="button" class="btn btn-outline-light waves-effect btn-remove-topic" data-target="${stepIndex}${newTopicIndex}" title="Remover Bloco" tabindex="0"><i class="ri-delete-bin-line text-danger text-opacity-50"></i></button>
