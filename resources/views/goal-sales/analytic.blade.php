                        ...
                        <div class="mt-3">
                            @foreach ($departments as $department)
                                <div class="row align-items-center g-2">
                                    ...
                                    <div class="col">
                                        <div class="p-1">
                                            <div class="progress animated-progress custom-progress progress-sm" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="{{ $department->progress }}" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-html="true" title="{{ $department->tooltip }}" tabindex="0">
