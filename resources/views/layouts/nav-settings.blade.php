<div id="scrollbar">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link menu-link" href="{{ url('settings-account') }}">
            ...
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarAPIs">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="{{ url('settings-api-keys') }}" class="nav-link">@lang('translation.api-keys')</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('settings-storage') }}" class="nav-link">@lang('translation.file-manager')</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('settings-database') }}" class="nav-link">@lang('translation.your-erp')</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link menu-link" href="{{ url('settings-users') }}">
                    <i class="ri-admin-fill"></i> <span>@lang('translation.users')</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link menu-link" href="{{ url('settings-security') }}">
