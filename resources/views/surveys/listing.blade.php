                                        ...
                                        <div class="avatar-group float-start me-1 mt-1 mb-1">
                                            @if (isset($delegation['auditors']) && !empty($delegation['auditors']))
                                                @foreach ($delegation['auditors'] as $key => $value)
                                                    ...
                                                    @endphp
                                                    @if($userId)
                                                        <a href="{{ route('profileShowURL', $userId) }}" class="avatar-group-item border-1 border-secondary" data-img="{{ $getUserData['avatar'] }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Auditoria: {{ $getUserData['name'] }} : {{ $companyName }}">
                                                            <img src="{{ $getUserData['avatar'] }}" alt="" class="rounded-circle avatar-xxs">
                                                        </a>
                                                    @endif
                                                @endforeach
