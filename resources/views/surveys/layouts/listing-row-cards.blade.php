    ...
    <div class="col-sm-12 col-md-6">
        <div class="card mb-2">
            <a class="card-body bg-info-subtle"><!-- data-bs-toggle="collapse" href="#leadDiscovered" role="button"
                ...
                <p class="text-muted mb-0"><span class="fw-medium">{{ is_array($distributedData['surveyor']) ? count($distributedData['surveyor']) : ''}} lojas</span></p>
            </a>
        </div>
        <!--end card-->
    ...
    <div class="col-sm-12 col-md-6">
        <div class="card mb-2">
            <a class="card-body bg-primary-subtle"><!-- data-bs-toggle="collapse" href="#contactInitiated" role="button"
                ...
                <p class="text-muted mb-0"><span class="fw-medium">{{ is_array($distributedData['auditor']) ? count($distributedData['auditor']) : ''}} lojas</span></p>
            </a>
        </div>
        <!--end card-->
