                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <label for="NoSwitchCheck{{ $topicIndex.$radioIndex }}" class="btn btn-{{$complianceSurvey && $complianceSurvey == 'no' ? '' : 'outline-'}}danger waves-effect waves-light d-flex align-content-center flex-wrap ms-1 me-1 mb-0 rounded-2 border-1 border-danger border-opacity-10" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Não Conforme">
                                            <i class="ri-thumb-down-line label-icon align-middle rounded-pill fs-1 m-auto"></i>
                                            {{--ri-close-line--}}
