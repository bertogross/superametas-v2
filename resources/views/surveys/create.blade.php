                                    ...
                                    <div class="row">
                                        @foreach ($getActiveCompanies as $company)
                                            <div class="col-sm-12 col-md-6 col-lg-4" id="distributed-tab-company-{{ $company->company_id }}"
                                                @if ($data && $countAllResponses > 0 && in_array($company->company_id, $selectedCompanies))
                                                    style="display: block;"
                                                @else
                                                    style="display: none;"
                                                @endif
                                                                ...
                                                                @if ( is_array($userCompanies) && in_array($company->company_id, $userCompanies) )
                                                                    <li>
                                                                        <div class="form-check form-check-success d-flex align-items-center">
                                                                            <input class="form-check-input form-check-input-users me-3 wizard-switch-control" type="radio" name="delegated_to[{{$company->company_id}}]"
                                                                                value="{{ $userId }}" id="delegated_to-user-{{ $company->company_id.$userId }}" {{ $isDelegated ? 'checked' : '' }}>
                                                                            <label class="form-check-label d-flex align-items-center"
                                                                                for="delegated_to-user-{{ $company->company_id.$userId }}">
