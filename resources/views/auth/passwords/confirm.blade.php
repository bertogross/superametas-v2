                                                ...
                                                <div class="d-flex flex-column h-100">
                                                    <div class="mb-4 mb-md-5">
                                                        <a href="{{ url('/') }}" class="d-block auth-logo">
                                                            <img src="{{ URL::asset('build/images/logo-dark' . $logo2 . '.png')}}" alt="logo" height="22" class="auth-logo-dark me-start" loading="lazy">
                                                            <img src="{{ URL::asset('build/images/logo-light' . $logo2 . '.png')}}" alt="logo" height="22" class="auth-logo-light me-start" loading="lazy">
                                                        </a>
                                                    </div>
