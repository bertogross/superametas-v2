                                    ...
                                    <div class="flex-shrink-0">
                                        <div class="dropdown dropstart me-n2">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <li>
                                                    <a href="<?php echo e(route('surveysTemplateShowURL', $template->id)); ?>" class="dropdown-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="left" title="Visualizar Modelo">Visualizar</a>
                                                </li>
                                            </div>
                                        </div>
                                    </div>
