                        ...
                        <div class="col-auto">
                            <?php if($currentUserId == $auditorId): ?>
                                <?php if( in_array($statusKey, ['new','pending','in_progress'])): ?>
                                    ...
                                    class="btn btn-sm btn-label right waves-effect btn-soft-<?php echo e($status['color']); ?> btn-assignment-auditor-action"
...
<?php endif; ?>
<?php /**PATH D:\www\superametas\applicationV2\development.superametas.com\public_html\resources\views\surveys\layouts\_deprecated\profile-auditors-box.blade.php ENDPATH**/ ?>