                    ...
                    <ul class="nav nav-tabs nav-border-top nav-justified" role="tablist">
                        <?php $__currentLoopData = $getAuthorizedCompanies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $companyId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link <?php echo e($key == 0 ? 'active' : ''); ?> text-uppercase" id="company-<?php echo e($companyId); ?>-tab" data-bs-toggle="tab" data-bs-target="#company-<?php echo e($companyId); ?>" type="button" role="tab" aria-controls="company-<?php echo e($companyId); ?>" aria-selected="true"><?php echo e(getCompanyAlias($companyId)); ?></button>
                            </li>
                                    ...
                                    <div class="accordion custom-accordionwithicon custom-accordion-border accordion-border-box mt-1" id="accordion-<?php echo e($companyId); ?>">
                                        <?php $__currentLoopData = range($endYear, $startYear); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aYear): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="accordion-<?php echo e($companyId.$aYear); ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(getCompanyAlias($companyId)); ?> ano <?php echo e($aYear); ?>">
                                                                ...
                                                                <?php $__currentLoopData = $periods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $period): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    ...
                                                                    <tr data-meantime="<?php echo e($period); ?>" data-company="<?php echo e($companyId); ?>">
                                                                        ...
                                                                        <td class="align-middle pe-3 ps-3" width="80">
                                                                            <?php if(empty($Id)): ?>
                                                                                <button type="button" class="btn btn-sm btn-outline-theme btn-goal-sales-edit waves-effect waves-light float-end w-100" data-meantime="<?php echo e($period); ?>" data-company-id="<?php echo e($companyId); ?>" data-company-name="<?php echo e(getCompanyAlias($companyId)); ?>" data-purpose="store" title="Adicionar Meta de Vendas <?php echo e($period); ?> <?php echo e(count($getActiveCompanies) > 1 ? ':: '.getCompanyAlias($companyId) : ''); ?>" modal-title="Adicionar Meta de Vendas :: <span class='text-theme'><?php echo e(getCompanyAlias($companyId)); ?></span>">Adicionar</button>
                                                                            <?php else: ?>
                                                                                <button type="button" class="btn btn-sm btn-theme btn-goal-sales-edit waves-effect waves-light float-end w-100" data-id="<?php echo e($Id); ?>" data-meantime="<?php echo e($period); ?>" data-company-id="<?php echo e($companyId); ?>" data-company-name="<?php echo e(getCompanyAlias($companyId)); ?>" data-purpose="update" title="Editar Meta de Vendas <?php echo e($period); ?> <?php echo e(getCompanyAlias($companyId)); ?>" modal-title="Editar Meta de Vendas :: <span class='text-theme'><?php echo e(getCompanyAlias($companyId)); ?></span>">Editar</button>
                                                                            <?php endif; ?>
                                                                        </td>
                                                                    </tr>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
