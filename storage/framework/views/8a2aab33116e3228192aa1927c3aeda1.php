...
<?php $__env->startSection('content'); ?>
    ...
    <div id="content" class="rounded rounded-2 mb-4">
        <div class="bg-warning-subtle position-relative">
            ...
            <?php if(!$preview): ?>
                <a href="<?php echo e(route('auditsComposeEditURL', ['id' => $data->id])); ?>" class="btn btn-sm btn-light btn-icon waves-effect ms-2 float-end m-3" title="Editar registro: <?php echo e(limitChars($data->title ?? '', 20)); ?>"><i class="ri-edit-line"></i></a>
            <?php endif; ?>
        ...
        <div>
            <?php echo $__env->make('audits.includes.steps-card', ['topicsData' => $topicsData], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <?php
