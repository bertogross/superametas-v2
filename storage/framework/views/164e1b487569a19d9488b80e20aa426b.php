...
<?php $__env->startSection('content'); ?>
                ...
                <div id="teamlist">
                    <div class="team-list grid-view-filter row" id="team-member-list">
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $__env->startComponent('components.settings-card-user'); ?>
                                <?php $__env->slot('id'); ?> <?php echo e($user->id); ?> <?php $__env->endSlot(); ?>
                                <?php $__env->slot('title'); ?> <?php echo e($user->name); ?> <?php $__env->endSlot(); ?>
                                <?php $__env->slot('role'); ?> <?php echo e($user->getRoleName($user->role)); ?> <?php $__env->endSlot(); ?>
                            <?php echo $__env->renderComponent(); ?>
    ...
    <?php echo $__env->make('components/settings-modal-user-form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>


<?php $__env->stopSection(); ?>
<?php $__env->startSection('script'); ?>
    <script src="<?php echo e(URL::asset('build/js/settings-users.js')); ?>"></script>
