                            ...
                            <table class="table align-middle table-nowrap mb-0">
                                ...
                                <tbody class="list form-check-all">
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <?php if(getGoogleToken()): ?>
                                                <a class="btn btn-danger" href="<?php echo e(route('GoogleDriveDeauthorizeURL')); ?>">
                                                    Deauthorize Google Drive
                                                </a>
                                            <?php else: ?>
                                                <a class="btn btn-primary" href="<?php echo e(route('GoogleDriveRedirectURL')); ?>" target="_blank">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <?php if(getDropboxToken()): ?>
                                                <a class="btn btn-danger" href="<?php echo e(route('DropboxDeauthorizeURL')); ?>">
                                                    Deauthorize Dropbox
                                                </a>
                                            <?php else: ?>
                                                <a class="btn btn-primary" target="_blank" href="<?php echo e(route('DropboxAuthorizeURL')); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\www\superametas\application\development.superametas.com\public_html\resources\views/settings/api-keys.blade.php ENDPATH**/ ?>