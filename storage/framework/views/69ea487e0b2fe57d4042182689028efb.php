                                ...
                                <?php $__currentLoopData = $topicsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stepIndex => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div id="<?php echo e($originalIndex); ?>" class="accordion-item block-item mt-3 mb-0 border-dark border-1 rounded rounded-2 p-0">
                                        ...
                                        <div class="accordion-collapse collapse show">
                                             ...
                                             <?php $__env->startComponent('surveys.components.topics-input'); ?>
                                                <?php $__env->slot('type', $type); ?>
                                                <?php $__env->slot('topicsData', $step['topicData']); ?>
                                                <?php $__env->slot('originalIndex', $originalIndex); ?>
                                            <?php echo $__env->renderComponent(); ?>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\www\superametas\applicationV2\development.superametas.com\public_html\resources\views\surveys\_deprecated\compose\create.blade.php ENDPATH**/ ?>