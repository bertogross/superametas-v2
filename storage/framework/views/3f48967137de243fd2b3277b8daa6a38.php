                                                            ...
                                                            <tbody>
                                                                ...
                                                                <?php $__currentLoopData = $periods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $period): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <?php
                                                                        ...
                                                                        //get post ID from meta_values company, year and month
                                                                        //$postId = APP_goal-sales_get_post_id($emp_ID, $period);
                                                                        //$postId = !empty($post_ID) ? base64_encode($post_ID) : '';
                                                                    ?>
                                                                    <tr id="<?php echo e($period); ?>-<?php echo e($company); ?>">
                                                                        ...
                                                                        <td class="align-middle pe-3 ps-3" width="80">
                                                                            <?php if(empty($postId)): ?>
                                                                                <button type="button" class="btn btn-sm btn-outline-theme btn-goal-sales-edit waves-effect waves-light float-end w-100" data-post-type="<?php echo e($postType); ?>" data-meantime="<?php echo e($period); ?>" data-company-id="<?php echo e($company); ?>" data-purpose="add" title="Adicionar Meta de Vendas <?php echo e($period); ?> <?php echo e(count($getActiveCompanies) > 1 ? ':: '.getCompanyAlias(intval($company)) : ''); ?>" modal-title="Adicionar Meta de Vendas :: <span class='text-theme'><?php echo e(getCompanyAlias(intval($company))); ?></span>">Adicionar</button>
                                                                            <?php else: ?>
                                                                                <button type="button" class="btn btn-sm btn-theme btn-load-secondary waves-effect waves-light float-end w-100" data-post-type="<?php echo e($postType); ?>" data-id="<?php echo e($postId); ?>" data-meantime="<?php echo e($period); ?>" data-company-id="<?php echo e($company); ?>" data-purpose="edit" title="Editar Meta de Vendas <?php echo e($period); ?> <?php echo e(getCompanyAlias(intval($company))); ?>" modal-title="Editar Meta de Vendas :: <span class='text-theme'><?php echo e(getCompanyAlias(intval($company))); ?></span>">Editar</button>
                                                                            <?php endif; ?>
                                                                        </td>
                                                                    </tr>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH D:\www\superametas\application\development.superametas.com\public_html\resources\views/goal-sales-settings.blade.php ENDPATH**/ ?>
