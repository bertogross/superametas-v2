<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stepIndex => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    ?>
    <div id="<?php echo e($termId); ?>" class="accordion-item block-item mt-3 mb-0 border-light border-1 rounded rounded-2 p-0">
        <div class="input-group">
            <input type="text" class="form-control text-theme text-uppercase" name="steps[<?php echo e($stepIndex); ?>]['stepData']['term_name']" value="<?php echo e($termName); ?>" placeholder="Setor/Etapa" maxlength="100" readonly required tabindex="-1">
