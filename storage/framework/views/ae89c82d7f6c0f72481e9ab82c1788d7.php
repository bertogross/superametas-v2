...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?>
            <?php if($data): ?>
                Edição de Modelo <small><i class="ri-arrow-drop-right-fill text-theme ms-2 me-2 align-bottom"></i> #<span class="text-theme me-2"><?php echo e($data->id); ?></span> <?php echo e(limitChars($data->title ?? '', 20)); ?></small>
            <?php else: ?>
    ...
    <?php else: ?>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <h4 class="card-title mb-0"><i class="ri-survey-fill fs-16 align-middle text-theme me-2"></i><?php echo e($data->title ?? 'Formulário'); ?></h4>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xxl-7">
                            <div class="p-3">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="title" name="title" class="form-control" value="<?php echo e($title); ?>" maxlength="100" placeholder="Exemplo: Checklist Abertura de Loja" required>
                                    <div class="form-text">O título servirá para identificar o modelo na listagem</div>
                                </div>

                                <div>
                                    <label for="description" class="form-label">Descrição:</label>
                                    <textarea name="description" class="form-control maxlength" id="description" rows="5" maxlength="500" placeholder="Descreva, por exemplo, as diretrizes para execução dos tópicos relacionados a este modelo"><?php echo e($description); ?></textarea>
                                ...
                                <div id="nested-compose-area" style="min-height: 250px;">
                                    ...
                                    <div class="mt-2 text-end">
                                        ...
                                        <button type="button" class="btn btn-label right btn-theme mt-5" id="btn-survey-template-store-or-update" tabindex="-1" data-autosave="no"><i class="ri-save-3-line label-icon align-middle fs-16 ms-1"></i><?php echo e($data ? 'Atualizar' : 'Salvar'); ?> Formulário</button>
                                    </div>
                                </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        var surveysTemplatePreviewURL = "<?php echo e(route('surveysTemplatePreviewURL')); ?>";
