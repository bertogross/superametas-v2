                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xxl-6">
                            <div class="p-3">
                                ...
                                <div>
                                    ...
                                    <textarea name="description" class="form-control maxlength" id="description" rows="3" maxlength="500" placeholder="Descreva, por exemplo, as diretrizes para execução dos tópicos relacionados a este modelo"><?php echo e($description); ?></textarea>
