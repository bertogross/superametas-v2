<?php
    ...
    $surveyorAssignmentId = $surveyorAssignmentData->id ?? null;
    $surveyorStatus = $surveyorAssignmentData->surveyor_status ?? null;

    $companyId = $surveyorAssignmentData->company_id ?? '';
...
<?php $__env->startSection('content'); ?>
    ...
    <div id="content" class="rounded rounded-2 mb-4">
        <div class="bg-info-subtle position-relative">
            <div class="card-body p-5 text-center">
                ...
                <div class="mb-0 text-muted">
                    Atualizado em:
                    <?php echo e($surveyData->updated_at ? \Carbon\Carbon::parse($surveyData->updated_at)->locale('pt_BR')->isoFormat('D [de] MMMM, YYYY - HH:mm:ss') . 'hs' : '-'); ?>
        ...
        <?php if($currentUserId != $surveyorAssignmentData->surveyor_id): ?>
            ...
            <div id="survey-assignment-container">
                ...
                <?php if($surveyData): ?>
                    <?php $__env->startComponent('surveys.layouts.form-surveyor-step-cards'); ?>
                        ...
                        <?php $__env->slot('surveyorAssignmentId', $surveyorAssignmentId); ?>
                    <?php echo $__env->renderComponent(); ?>
                <?php endif; ?>
            </div>
        <?php endif; ?>
