...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->endSlot(); ?>
        <?php $__env->slot('title'); ?> Clarifai  <?php $__env->endSlot(); ?>
            ...
            reader.addEventListener("load", function() {
                ...
                img.onload = function() {
                    ...
                    canvas.toBlob(function(blob) {
                        ...
                        fetch('<?php echo e(route('ClarifaiSubmitURL')); ?>', {
                            method: 'POST',
                            body: formData,
                            headers: {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\www\superametas\applicationV2\development.superametas.com\public_html\resources\views\settings\clarifai.blade.php ENDPATH**/ ?>