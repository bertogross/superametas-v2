<?php if( $data ): ?>
                    ...
                    <div class="card mb-0 bg-body">
                        <div class="card-body">
                            <form class="responses-data-container" autocomplete="off">
                                ...
                                <div class="gallery-wrapper row m-0 mb-3"><?php if( !empty($attachmentIds) && is_array($attachmentIds) ): ?>
                                        ...
                                        <?php if($attachmentUrl): ?>
                                            <div id="element-attachment-<?php echo e($attachmentId); ?>" class="element-item col-auto">
                                                ...
                                                <?php if( $surveyorStatus != 'auditing' && $surveyorStatus != 'losted' ): ?>
                                                    <div class="position-absolute translate-middle mt-n4 me-n4">
                                                        <div class="avatar-xs">
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="btn-group">
                                        <?php if( $surveyorStatus != 'auditing' && $surveyorStatus != 'losted' ): ?>
                                            <label for="input-attachment-<?php echo e($radioIndex); ?>" class="btn btn-light waves-effect waves-light d-flex align-content-center flex-wrap me-1 mb-0 rounded-2 btn-add-photo" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Anexar Fotografia" data-step-id="<?php echo e($stepId); ?>" data-topic-id="<?php echo e($topicId); ?>">
                                        ...
                                        <label class="btn btn-light waves-effect waves-light d-flex align-content-center flex-wrap text-center ms-1 me-1 mb-0 btn-toggle-element rounded-2" data-toggle-target="textarea-<?php echo e($topicIndex.$radioIndex); ?>" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Adicionar Observações"><i class="ri-feedback-line text-body fs-1 m-auto"></i></label>
                                        ...
                                        <label for="NoSwitchCheck<?php echo e($topicIndex.$radioIndex); ?>" class="btn btn-<?php echo e($complianceSurvey && $complianceSurvey == 'no' ? '' : 'outline-'); ?>danger waves-effect waves-light d-flex align-content-center flex-wrap ms-1 me-1 mb-0 rounded-2 border-1 border-danger border-opacity-10" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Não Conforme">
                                            <i class="ri-emotion-unhappy-line label-icon align-middle rounded-pill fs-1 m-auto"></i>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH D:\www\superametas\applicationV2\development.superametas.com\public_html\resources\views/surveys/layouts/form-surveyor-step-cards-v2.blade.php ENDPATH**/ ?>