                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-auto">
                                                        <div class="form-check form-switch form-switch-sm form-switch-theme mb-4" title="Em conformidade">
                                                            ...
                                                            <label class="form-check-label" for="YesSwitchCheck<?php echo e($topicIndex.$radioIndex); ?>">Aprovada</label>
                                                        </div>
                                                        <div class="form-check form-switch form-switch-sm form-switch-danger" title="Não conforme">
                                                            ...
                                                            <label class="form-check-label" for="NoSwitchCheck<?php echo e($topicIndex.$radioIndex); ?>">Indeferida</label>
                                                        </div>
                                                    </div>
                                                </div>
