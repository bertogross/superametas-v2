<?php if( $stepsWithTopics ): ?>
                            ...
                            <form class="responses-data-container" autocomplete="off">
                                ...
                                <div class="row">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <label for="NoSwitchCheck<?php echo e($topicIndex.$radioIndex); ?>" class="btn btn-<?php echo e($complianceAudit && $complianceAudit == 'no' ? '' : 'outline-'); ?>danger waves-effect waves-light d-flex align-content-center flex-wrap ms-1 me-1 mb-0 rounded-2 border-1 border-danger border-opacity-10 btn-compliance" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Discordo">
                                        ...
                                        <label for="YesSwitchCheck<?php echo e($topicIndex.$radioIndex); ?>" class="btn btn-<?php echo e($complianceAudit && $complianceAudit == 'yes' ? '' : 'outline-'); ?>success waves-effect waves-light d-flex align-content-center flex-wrap ms-1 me-0 mb-0 rounded-2 border-1 border-success border-opacity-10 btn-compliance" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="bottom" title="Concordo">
    ...
    <?php if( $auditorStatus != 'completed' && $auditorStatus != 'losted' ): ?>
        <button tabindex="-1"
            type="button"
            class="btn btn-lg btn-theme waves-effect w-100 <?php echo e($countResponses < $countTopics ? 'd-none' : ''); ?>"
