            ...
            <div class="d-flex align-items-center">
                ...
                <div class="flex-shrink-0">
                    <div class="d-flex flex-wrap gap-2">
                        <?php $__env->startComponent('audits.components.nav'); ?>
                            <?php $__env->slot('url', route('auditsIndexURL')); ?>
                        <?php echo $__env->renderComponent(); ?>
                    </div>
                </div>
            </div>
            ...
            <div class="tab-content text-muted">
                <div class="tab-pane active" id="departments" role="tabpanel">
                    <?php if($default->isEmpty()): ?>
                        <?php $__env->startComponent('components.nothing'); ?>
                            <?php $__env->slot('url', route('auditsComposeAddURL', ['type'=>'default'])); ?>
                        <?php echo $__env->renderComponent(); ?>
                    <?php else: ?>
                                    ...
                                    <?php $__currentLoopData = $default; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td scope="row" class="text-end">
                                                <div class="btn-group">
                                                    <a href="<?php echo e(route('auditsComposeEditURL', $data->id)); ?>" class="btn btn-sm btn-outline-dark" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Editar"><i class="ri-edit-line"></i></a>

                                                    <a href="<?php echo e(route('auditsComposeShowURL', $data->id)); ?>" class="btn btn-sm btn-outline-dark" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Visualizar"><i class="ri-eye-line"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                ...
                <div class="tab-pane" id="custom" role="tabpanel">
                    <?php if($custom->isEmpty()): ?>
                        <?php $__env->startComponent('components.nothing'); ?>
                            <?php $__env->slot('url', route('auditsComposeAddURL', ['type'=>'custom'])); ?>
                        <?php echo $__env->renderComponent(); ?>
                    <?php else: ?>
                        <div class="table-responsive">
                            <table class="table align-middle table-nowrap mb-0 table-striped table-hover" id="composeTable">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\www\superametas\application\development.superametas.com\public_html\resources\views/audits/compose/listing.blade.php ENDPATH**/ ?>