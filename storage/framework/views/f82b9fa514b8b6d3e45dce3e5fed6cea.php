                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                                    ...
                                    <form action="auth-signin-basic">
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup">
                                                ...
                                                <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button"
                                                    id="password-addon"><i class="ri-eye-fill align-middle text-body"></i></button>
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                ...
                                                <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button" id="confirm-password-input"><i class="ri-eye-fill align-middle text-body"></i></button>
                                            </div>
                                        </div>
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Espere, eu lembrei qual minha senha... <a href="auth-signin-basic" class="fw-semibold text-theme text-decoration-underline"> Clique aqui </a> </p>
                        </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\www\superametas\application\development.superametas.com\public_html\resources\views\_many_other_templates\auth-pass-change-basic.blade.php ENDPATH**/ ?>