        ...
        <div class="modal-content border-0">
            <div class="modal-header p-3 bg-soft-info">
                <h5 class="modal-title">
                    <?php if($surveyId): ?>
                        Edição de: <span class="text-theme"><?php echo e(limitChars(getSurveyTemplateNameById($templateId), 30)); ?></span>
                    <?php else: ?>
                    ...
                    <div class="tab-content">
                        ...
                        aria-labelledby="steparrow-template-info-tab">
                            ...
                            <?php else: ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control wizard-input-control" maxlength="100" id="title-field" name="title" name="template_id" value="<?php echo e($title); ?>" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <?php if( $data && $countAllResponses > 0 && !in_array($surveyStatus, ['new', 'scheduled']) ): ?>
                                        <?php echo $alertMessage0; ?>

                                        <input type="hidden" name="template_id" value="<?php echo e($templateId); ?>">
                                    <?php else: ?>
                                        <select name="template_id" id="template-field" class="form-control form-select wizard-input-control" <?php echo e($countAllResponses > 0 ? 'readonly' : ''); ?> required>
                                            <option value="" <?php echo e(!$templateId ? 'selected' : 'disabled'); ?>>- Selecione -</option>
                                            <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($template->id); ?>" <?php echo e(isset($template->id) && $template->id == $templateId ? 'selected' : ''); ?>><?php echo e($template->title ? e($template->title) : ''); ?></option>
                            ...
                            <div class="mb-4">
                                ...
                                <?php if( $data && $countAllResponses > 0 && !in_array($surveyStatus, ['new', 'scheduled']) ): ?>
                                    ...
                                    <?php $__currentLoopData = $getActiveCompanies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(!empty($selectedCompanies) && is_array($selectedCompanies) && in_array(intval($company->company_id), $selectedCompanies)): ?>
                                            <input type="hidden" name="companies[]" value="<?php echo e($company->company_id); ?>">
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php else: ?>
                                        ...
                                        <?php $__currentLoopData = $getActiveCompanies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col">
                                                <div class="form-check form-switch form-switch-theme form-switch-md">
                                                    ...
                                                    type="checkbox"
                                                    role="switch"
                                                    <?php echo e(!empty($selectedCompanies) && is_array($selectedCompanies) && in_array(intval($company->company_id), $selectedCompanies) ? 'checked' : ''); ?>
                        ...
                        <div class="tab-pane fade" role="tabpanel" id="steparrow-recurring-info" aria-labelledby="steparrow-recurring-info-tab">
                            <div class="mb-3">
                                ...
                                <?php else: ?>
                                    <select name="recurring" id="date-recurring-field" class="form-control form-select wizard-input-control" required <?php echo e($countAllResponses > 0 ? 'readonly' : ''); ?>>
                                        <option value="" <?php echo e(!$recurring ? 'selected disabled' : 'disabled'); ?>>- Selecione -</option>
                            ...
                            <div class="mb-3">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input id="date-recurring-start" type="text" class="form-control flatpickr-input flatpickr-between wizard-input-control" <?php echo e($countAllResponses > 0 && in_array($surveyStatus, ['started', 'stopped', 'completed', 'filed']) ? 'disabled' : ''); ?> name="start_at" data-date-format="d/m/Y" value="<?php echo e($startAt); ?>">
                                        <?php if( in_array($surveyStatus, ['started', 'stopped', 'completed', 'filed']) ): ?>
                                    ...
                                    <div class="col">
                                        ...
                                        <input id="date-recurring-end" type="text" class="form-control flatpickr-input flatpickr-between wizard-input-control" name="end_in" data-date-format="d/m/Y" value="<?php echo e($endIn); ?>">
                        ...
                        aria-labelledby="steparrow-users-info-tab">
                            <?php if( empty($getActiveCompanies) || !is_array($getActiveCompanies) ): ?>
                                <?php $__env->startComponent('components.nothing'); ?>
                            ...
                            <?php else: ?>
                                <div>
                                    ...
                                    <?php if($getActiveCompanies && count($getActiveCompanies) > 1): ?>
                                                    ...
                                                    <div class="card-body">
                                                        <ul class="list-unstyled vstack gap-2 mb-0">
                                                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                ...
                                                                ?>
                                                                <?php if( is_array($userCompanies) && in_array($company->company_id, $userCompanies) ): ?>
                                                                    <li>
                                                                        <div class="form-check form-check-success d-flex align-items-center">
                                                                            <input class="form-check-input form-check-input-users me-3 wizard-switch-control" type="radio" name="delegated_to[<?php echo e($company->company_id); ?>]"
                                                                                value="<?php echo e($userId); ?>" id="delegated_to-user-<?php echo e($company->company_id.$userId); ?>" <?php echo e($isDelegated ? 'checked' : ''); ?>>
                                                                            <label class="form-check-label d-flex align-items-center"
                                                                                for="delegated_to-user-<?php echo e($company->company_id.$userId); ?>">
