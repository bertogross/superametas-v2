...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?>
            <?php if($audit): ?>
                Edição de Audotoria<small><i class="ri-arrow-drop-right-fill text-theme ms-2 me-2 align-bottom"></i> #<span class="text-theme"><?php echo e($audit->id); ?></span> </small>
            <?php else: ?>
                Cadastrar Auditoria
            <?php endif; ?>
        <?php $__env->endSlot(); ?>
    ...
    <?php
        $auditId = $audit->id ?? '';
        $created_by = $audit->created_by ?? auth()->id();
        $assigned_to = $audit->assigned_to ?? '';
        $delegated_to = $audit->delegated_to ?? '';
    ...
    <div class="card">
        <div class="card-header">
            <div class="float-end">
                <?php if($audit): ?>
                    <button type="button" class="btn btn-sm btn-outline-theme" id="btn-audits-store-or-update" tabindex="-1">Atualizar</button>

                    <button type="button" class="btn btn-sm btn-outline-info" id="btn-audits-clone" tabindex="-1">Clonar</button>
                <?php else: ?>
                    <button type="button" class="btn btn-sm btn-theme" id="btn-audits-store-or-update" tabindex="-1">Salvar</button>
                <?php endif; ?>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-5 col-lg-4 col-xxl-3">
                    <div class="p-3 border border-1 border-light rounded">
                        <form id="auditsForm" method="POST" autocomplete="off" class="needs-validation" novalidate autocomplete="false">
                            <?php echo csrf_field(); ?>
                    ...
                    <div class="p-3 border border-1 border-light rounded">
                        ...
                        <div class="tab-content text-muted p-3 border border-1 border-light rounded rounded-top-0">
                            <div class="tab-pane active" id="arrow-departments" role="tabpanel">
                                <h6>Departamentos</h6>
                                <div class="mb-3">
                                    <select class="form-select" name="audit_compose_default_id" id="audit_compose_default_id">
                                        <option value="">- Selecionar Formulário -</option>
                                        <?php $__currentLoopData = $getAuditComposeDefault; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $default): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($default->id); ?>" <?php if(old('audit_compose_default_id', $auditComposeDefaultId ?? '') == $default->id): echo 'selected'; endif; ?>>
                            ...
                            <div class="tab-pane" id="arrow-custom" role="tabpanel">
                                ...
                                <div class="mb-3">
                                    <select class="form-select" name="audit_compose_custom_id" id="audit_compose_custom_id">
                                        <option value="">- Selecionar Formulário -</option>
                                        <?php $__currentLoopData = $getAuditComposeCustom; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $custom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($custom->id); ?>" <?php if(old('audit_compose_custom_id', $auditComposeCustomId ?? '') == $custom->id): echo 'selected'; endif; ?>>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        var auditsEditURL = "<?php echo e(route('auditsEditURL')); ?>";
        var auditsCreateOrUpdateURL = "<?php echo e(route('auditsCreateOrUpdateURL')); ?>";
    </script>
    <script src="<?php echo e(URL::asset('build/js/audits.js')); ?>" type="module"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\www\superametas\application\development.superametas.com\public_html\resources\views/audits/add.blade.php ENDPATH**/ ?>