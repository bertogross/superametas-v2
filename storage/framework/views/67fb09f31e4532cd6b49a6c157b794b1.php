<div class="dropstart float-end">
    ...
    <ul class="dropdown-menu">
        ...
        <a class="dropdown-item" href="<?php echo e(route('auditsComposeURL')); ?>" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="left" title="Compor Formulário de Vistoria">
