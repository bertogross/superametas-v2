<div class="col" data-search-user-id="<?php echo e($id); ?>" data-search-user-name="<?php if(isset($name)): ?> <?php echo e($name); ?> <?php endif; ?>" data-search-user-role="<?php if(isset($role)): ?><?php echo e($role); ?><?php endif; ?>">
    <div class="card team-box">
        <div class="team-cover" style="min-height: 140px">
            ...
            <?php endif; ?>
            alt="<?php if(isset($name)): ?><?php echo e($name); ?><?php endif; ?>" class="img-fluid" height="140" id="cover-img-<?php if(isset($id)): ?><?php echo e($id); ?><?php endif; ?>" loading="lazy">
        </div>
                ...
                <div class="col-lg-4 col">
                    <div class="team-profile-img">
                        <div class="avatar-lg img-thumbnail rounded-circle flex-shrink-0"><img
                            ...
                            class="member-img img-fluid d-block rounded-circle" id="avatar-img-<?php if(isset($id)): ?><?php echo e($id); ?><?php endif; ?>" loading="lazy">
                        </div>
