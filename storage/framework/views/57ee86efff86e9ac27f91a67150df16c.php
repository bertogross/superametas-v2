        ...
        <div class="card-body">
            <?php if($surveys->isEmpty()): ?>
                <?php $__env->startComponent('components.nothing'); ?>
                    <?php $__env->slot('url', route('surveysAddURL')); ?>
                <?php echo $__env->renderComponent(); ?>
            <?php else: ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\www\superametas\application\development.superametas.com\public_html\resources\views/surveys/index.blade.php ENDPATH**/ ?>