                                                ...
                                                <div class="w-100">
                                                    <div class="d-flex flex-column h-100">
                                                        <div class="mb-4 mb-md-5">
                                                            <a href="<?php echo e(env('APP_URL')); ?>" class="d-block auth-logo">
                                                        ...
                                                        <div class="auth-content my-auto">
                                                            <div class="text-center">
                                                                ...
                                                                <div class="mt-4">
                                                                    ...
                                                                    <div class="mt-4">
                                                                        <a href="<?php echo e(env('APP_URL')); ?>" class="btn btn-primary w-100">Back to Home</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="mt-4 text-center">
                                                            <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Borex   . Crafted with <i class="mdi mdi-heart text-danger"></i> by Supera Metas</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php $__env->stopSection(); ?>
<?php /**PATH D:\www\superametas\application\development.superametas.com\public_html\resources\views\auth\passwords\confirm.blade.php ENDPATH**/ ?>