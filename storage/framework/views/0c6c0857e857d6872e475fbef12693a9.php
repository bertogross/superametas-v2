<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stepIndex => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div id="<?php echo e($originalIndex); ?>" class="accordion-item block-item mt-3 mb-0 border-dark border-1 rounded rounded-2 p-0">
        <div class="input-group">
            <?php if( $type == 'custom' ): ?>
                <input type="text" class="form-control text-theme" name="['stepData']['step_name']" value="<?php echo e($stepName); ?>" placeholder="Informe o Título/Setor/Etapa" autocomplete="off" maxlength="100" required>
            <?php else: ?>
                ...
                readonly disabled>
                <input type="hidden" name="['stepData']['step_name']" value="<?php echo e($stepName); ?>">
            <?php endif; ?>
        ...
        <input type="hidden" name="['stepData']['type']" value="<?php echo e($type); ?>" tabindex="-1">
        <input type="hidden" name="['stepData']['original_position']" value="<?php echo e($originalPosition); ?>" tabindex="-1">
        <input type="hidden" name="['stepData']['new_position']" value="<?php echo e($newPosition); ?>" tabindex="-1">
                ...
                <?php $__currentLoopData = $topicsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topicIndex => $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div id="<?php echo e($originalIndex . $originalTopicIndex); ?>" class="step-item mt-1 mb-1">
                        <div class="row">
                            ...
                            <div class="col">
                                <select select-one data-choices-removeItem class="form-control surveys-term-choice w-100" title="Exemplo: Organização do setor?... Abastecimento de produtos/insumos está em dia?" data-placeholder="Tópico..." name="['topicsData'][<?php echo e($originalTopicIndex); ?>]['topic_id']" required>
                        ...
                        <input type="hidden" name="['topicsData'][<?php echo e($originalTopicIndex); ?>]['original_position']" value="<?php echo e($originalPosition); ?>" tabindex="-1">
                        <input type="hidden" name="['topicsData'][<?php echo e($originalTopicIndex); ?>]['new_position']" value="<?php echo e($newPosition); ?>" tabindex="-1">
                    </div>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH D:\www\superametas\applicationV2\development.superametas.com\public_html\resources\views/surveys/components/composer-form.blade.php ENDPATH**/ ?>