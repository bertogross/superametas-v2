...
unset($__errorArgs, $__bag); ?>" id="useremail"
                                                name="email" placeholder="E-mail aqui" value="<?php echo e(old('email')); ?>"
                                                id="email">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Espere, eu lembrei qual minha senha... <a href="<?php echo e(route('login')); ?>"
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> <?php echo e(env('APP_NAME')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\www\superametas\applicationV2\development.superametas.com\public_html\resources\views\auth\passwords\email.blade.php ENDPATH**/ ?>