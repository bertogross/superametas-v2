<div id="scrollbar">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link menu-link" href="<?php echo e(url('settings-account')); ?>">
            ...
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarAPIs">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="<?php echo e(url('settings-api-keys')); ?>" class="nav-link"><?php echo app('translator')->get('translation.api-keys'); ?></a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(url('settings-storage')); ?>" class="nav-link"><?php echo app('translator')->get('translation.file-manager'); ?></a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(url('settings-database')); ?>" class="nav-link"><?php echo app('translator')->get('translation.your-erp'); ?></a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link menu-link" href="<?php echo e(url('settings-users')); ?>">
                    <i class="ri-admin-fill"></i> <span><?php echo app('translator')->get('translation.users'); ?></span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link menu-link" href="<?php echo e(url('settings-security')); ?>">
