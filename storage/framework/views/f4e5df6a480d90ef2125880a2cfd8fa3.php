    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0">
            ...
            <div class="modal-body">
                <form autocomplete="off" id="memberlist-form" class="needs-validation" autocomplete="off" data-id="<?php echo e($user ? $user->id : ''); ?>" novalidate>
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-lg-12">
                                        ...
                                        <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-md-6">
                                                <div class="form-check form-switch form-switch-theme form-switch-md">
                                                    <input class="form-check-input" type="checkbox" role="switch" id="company-<?php echo e($company->company_id); ?>" name="companies[]" value="<?php echo e($company->company_id); ?>" <?php echo e(in_array($company->company_id, $selectedCompanies) ? 'checked' : ''); ?>>
...
<!--end modal-->
<?php /**PATH D:\www\superametas\application\development.superametas.com\public_html\resources\views/components/settings-users-modal-form.blade.php ENDPATH**/ ?>