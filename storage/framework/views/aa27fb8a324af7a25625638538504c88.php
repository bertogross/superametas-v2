...
<?php $__env->startSection('content'); ?>
    ...
    <div id="content">
            ...
            <div class="bg-warning-subtle">
                <div class="card-body pb-4">
                    <h4 class="fw-semibold">
                        <span class="text-theme"><?php echo e($companyName); ?></span> <i class="ri-arrow-right-s-fill align-bottom"></i> <?php echo e(limitChars($templateName ?? '', 100)); ?>
        ...
        <?php if($templateDescription): ?>
            ...
            <p class="text-muted">
                <?php echo e($templateDescription); ?>
