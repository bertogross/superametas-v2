<?php echo $__env->yieldContent('css'); ?>
    ...
    <!-- custom Css-->
    <link href="<?php echo e(URL::asset('build/css/custom.min.css')); ?>?v=<?php echo e(env('APP_VERSION')); ?>" id="app-style" rel="stylesheet" type="text/css" />
    
<?php /**PATH D:\www\superametas\applicationV2\development.superametas.com\public_html\resources\views/layouts/head-css.blade.php ENDPATH**/ ?>