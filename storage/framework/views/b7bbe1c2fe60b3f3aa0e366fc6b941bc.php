        ...
        <div class="card-body">
            <?php if($composes->isEmpty()): ?>
                <?php $__env->startComponent('components.nothing'); ?>
                    <?php $__env->slot('url', route('auditsComposeAddURL')); ?>
                <?php echo $__env->renderComponent(); ?>
            <?php else: ?>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $composes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $compose): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo e($compose->created_at ? \Carbon\Carbon::parse($compose->created_at)->locale('pt_BR')->isoFormat('D [de] MMMM, YYYY - HH:mm:ss') . 'hs' : '-'); ?>
