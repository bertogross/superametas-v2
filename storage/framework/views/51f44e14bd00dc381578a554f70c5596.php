                        ...
                        <div class="card-body">
                            <form class="responses-data-container" autocomplete="off">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <i class="fs-5 ri-time-line text-warning-emphasis <?php echo e(!$complianceSurvey || !$attachmentIds ? '' : 'd-none'); ?>"
                                        data-bs-toggle="tooltip" data-bs-trigger="hover"
                                        data-bs-placement="top" title="Status: Pendente"></i>

                                        <i class="fs-5 ri-check-double-fill text-theme <?php echo e($complianceSurvey && $attachmentIds ? '' : 'd-none'); ?>"
                                        data-bs-toggle="tooltip" data-bs-trigger="hover"
