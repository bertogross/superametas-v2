            ...
            <tbody>
                <?php if(!empty($upcoming) && isset($upcoming) && is_object($upcoming) && count($upcoming->lines->data) > 1): ?>
                    ...
                    <?php
                        ...
                        $total = $total > 0 ? formatBrazilianReal($total, 2) : '';
                ...
                <?php $__currentLoopData = $invoices->autoPagingIterator(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        ...
                        $adjusted_invoice_total = $post_payment_credit_notes_amount ? formatBrazilianReal(($invoice['total'] - $post_payment_credit_notes_amount)/100, 2) : '';
...
<?php endif; ?>
<?php /**PATH D:\www\superametas\applicationV2\development.superametas.com\public_html\resources\views/settings/stripe/billing.blade.php ENDPATH**/ ?>