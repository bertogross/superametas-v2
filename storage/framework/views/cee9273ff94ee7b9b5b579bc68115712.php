<?php
// appPrintR($getAuditStatusTranslations);
        ...
        <div class="card-body">
            <?php if($audits->isEmpty()): ?>
                <?php $__env->startComponent('components.nothing'); ?>
                    <?php $__env->slot('url', route('auditsAddURL')); ?>
                <?php echo $__env->renderComponent(); ?>
            <?php else: ?>
                                    ...
                                    <td scope="row" class="text-end">
                                        <div class="btn-group">
                                            <?php if($audit->status == 'pending' ): ?>
                                                <a href="<?php echo e(route('auditsEditURL', $audit->id)); ?>" class="btn btn-sm btn-outline-dark waves-effect" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Editar"><i class="ri-edit-line"></i></a>
                                            <?php else: ?>
