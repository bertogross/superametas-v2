        ...
        <div class="col-md-12 col-lg-3 col-xxl-2">
            <div class="card-body">
                <?php $__env->startComponent('surveys.components.nav-pills'); ?>
                    <?php $__env->slot('url', route('surveysComposeIndexURL')); ?>
                <?php echo $__env->renderComponent(); ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\www\superametas\applicationV2\development.superametas.com\public_html\resources\views/surveys/compose/listing.blade.php ENDPATH**/ ?>